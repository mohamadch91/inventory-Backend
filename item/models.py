...
class item(models.Model):
    ...
    CoolWaterProductionCapacity=models.FloatField(null=True,blank=True)
    ...
    CoolantPackNominalCapacity=models.FloatField(null=True,blank=True)
    ...
    OtherFieldsItem1=models.CharField(max_length=250, null=True,blank=True)
