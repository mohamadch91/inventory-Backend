...
class item(models.Model):
    ...
    TypeP=models.CharField(max_length=50, null=True,blank=True)
    ...
    Type3=models.CharField(max_length=50, null=True,blank=True)
    Type4=models.CharField(max_length=50, null=True,blank=True)
    Type5=models.CharField(max_length=50, null=True,blank=True)
    Type1P=models.CharField(max_length=50, null=True,blank=True)
    Height=models.IntegerField(null=True,blank=True)
    Width=models.IntegerField(null=True,blank=True)
    Length=models.IntegerField(null=True,blank=True)
    GrossVolume=models.IntegerField(null=True,blank=True)
    NetShippingVolume=models.IntegerField(null=True,blank=True)
    Weightkg=models.IntegerField(null=True,blank=True)
    ExternalSize=models.CharField(max_length=50, null=True,blank=True)
    ...
    PhysicalConditions=models.CharField(max_length=50, null=True,blank=True)
    TechnicalConditions=models.CharField(max_length=50, null=True,blank=True)
    WorkingConditions=models.CharField(max_length=50, null=True,blank=True)
    IsItFunctioning=models.BooleanField(null=True,blank=True)
    NotInUseSince=models.IntegerField(null=True,blank=True)
    ReasonsForNotFunctioning=models.CharField(max_length=50, null=True,blank=True)
    YearInstalled=models.CharField(max_length=50, null=True,blank=True)
    RunningTime=models.IntegerField(null=True,blank=True)
    RunningTimeKm=models.IntegerField(null=True,blank=True)
    StorageCondition=models.CharField(max_length=50, null=True,blank=True)
    NetVaccineStorageCapacity=models.IntegerField(null=True,blank=True)
    EnergySource=models.CharField(max_length=50, null=True,blank=True)
    FreezerNetCapacity=models.IntegerField(null=True,blank=True)
    IceMakingCapacity=models.IntegerField(null=True,blank=True)
    ...
    WorkingTemperatureRange=models.CharField(max_length=50, null=True,blank=True)
    RefrigerantGas=models.CharField(max_length=50, null=True,blank=True)
    ...
    wVSSMCode=models.CharField(max_length=50, null=True,blank=True)
    UNICEFCatalogueCodes=models.CharField(max_length=50, null=True,blank=True)
    OtherCode=models.CharField(max_length=50, null=True,blank=True)
    PQSPISCode=models.CharField(max_length=50, null=True,blank=True)
    PQSPISType=models.CharField(max_length=50, null=True,blank=True)
    PQSPISManufacturer=models.CharField(max_length=50, null=True,blank=True)
    PQSPISRefrigerantGas=models.CharField(max_length=50, null=True,blank=True)
    PQSPISTemperatureWorkingZone=models.CharField(max_length=50, null=True,blank=True)
