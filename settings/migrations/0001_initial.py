    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maxpop', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('minpop', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
