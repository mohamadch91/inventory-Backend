# Generated by Django 4.0.6 on 2022-08-03 00:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('maxpop', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True)),
                ('minpop', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True)),
                ...
                ('maxpopu1', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True)),
                ('minpopu1', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True)),
