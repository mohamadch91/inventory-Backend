...
class CountryConfig(models.Model):
    ...
    secondLogo = models.CharField(db_column='SecondLogo', max_length=200, blank=True, null=True)  # Field name made lowercase.
    poptarget =models.CharField(db_column='PopTarget',max_length=10,choices=TP.choices, null=True)
